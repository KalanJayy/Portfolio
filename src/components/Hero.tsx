      ...
      <div className={styles.grid}>
        <div className={styles.content}>
          ...
          <div className={styles.roleRow}>
            ...
            <span className={styles.roleTitle}>React / React Native &amp; Node.js</span>
          </div>

          <p className={styles.tagline}>
            Building precise, modern web &amp; mobile products
...
function GithubIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16" style={{ display: 'inline', verticalAlign: 'middle' }}>
...
function MailIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" width="16" height="16" style={{ display: 'inline', verticalAlign: 'middle' }}>
...
function ArrowDown() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" width="18" height="18" style={{ display: 'inline', verticalAlign: 'middle' }}>
